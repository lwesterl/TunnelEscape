...
%typemap(jstype) Vector2i "com.westerholmgmail.v.lauri.tunnelescape.Vector2i";
%typemap(jtype) Vector2i "com.westerholmgmail.v.lauri.tunnelescape.Vector2i";
...
%typemap(out) Vector2i {
    jclass jVectClass = jenv->FindClass("com/westerholmgmail/v/lauri/tunnelescape/Vector2i");
