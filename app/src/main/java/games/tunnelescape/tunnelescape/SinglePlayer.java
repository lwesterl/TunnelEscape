...
import games.tunnelescape.tunnelescape.objects.ImageObject;
import games.tunnelescape.tunnelescape.objects.ObjectType;
import games.tunnelescape.tunnelescape.objects.PlayerObject;
import games.tunnelescape.tunnelescape.objects.StaticObject;
import games.tunnelescape.tunnelescape.objects.TreasureObject;
...
SinglePlayer implements GameScreen {
    ...
    public static @FileType.FileTypeRef
    int CurrentLevel = FileType.Intro;
